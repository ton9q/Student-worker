DROP DATABASE IF EXISTS students; -- delete database students if you have this database
...
create table groups
(
  group_id int unsigned not null auto_increment, -- fields can't change, and its generate automatically
